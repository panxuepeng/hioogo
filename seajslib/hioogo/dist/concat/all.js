/* 2013-09-26 */
// 用来处理公共区域的操作，比如页头部分
define("hioogo/0.1.0/common", [ "./config" ], function(require, exports, module) {
...
define("hioogo/0.1.0/config", [], function(require, exports, module) {
...
define("hioogo/0.1.0/hioogo", [ "./router", "./config", "./common" ], function(require, exports) {
    var router = require("./router");
});
define("hioogo/0.1.0/login", [ "md5/1.0.0/md5", "./config", "./common" ], function(require, exports, module) {
...
define("hioogo/0.1.0/photo", [ "./config", "./common", "arttemplate/2.0.1/arttemplate" ], function(require, exports, module) {
    var Config = require("./config"), common = require("./common"), photoPlayer = null, template = require("arttemplate/2.0.1/arttemplate"), currentTopicid = 0, dom = $(document);
...
define("hioogo/0.1.0/post", [ "plupload/1.5.6/plupload", "./common", "./config" ], function(require, exports, module) {
...
define("hioogo/0.1.0/router", [ "./config", "./common" ], function(require, exports, module) {
    var Config = require("./config"), common = require("./common"), actionName = Config.index, Path = [], Params = {}, Actions = {};
